...
class TestIngestionService:
    ...
    def test_transcript_is_created(
        self,
        db_session,
        sample_fixture,
        ...
        transcript = (
            ...
            .filter_by(episode_id=fixture["episode_id"])
            .first()
        )

        assert transcript is not None
        assert transcript.title == fixture["title"]
        assert transcript.guest_name == fixture.get("guest_name")
    ...
    def test_embeddings_are_stored(
        self,
        db_session,
        sample_fixture,
        deterministic_provider,
    ...
    def test_ingestion_is_idempotent(
        ...
        result1 = service.ingest_episode(
            fixture,
            db_session,
            deterministic_provider,
        )
        ...
        result2 = service.ingest_episode(
            fixture,
            db_session,
            deterministic_provider,
        )
